...
// Module: rh.Cert.K0PPlus
// Imports: Init rh.academic_framework.EulerProduct.K0Bound
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_rh_Cert_K0PPlus(uint8_t builtin, lean_object* w) {
lean_object * res;
