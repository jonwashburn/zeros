...
// Module: rh.RS.DirectWedgeProof
// Imports: Init Mathlib.Analysis.SpecialFunctions.Complex.Log rh.Cert.KxiPPlus Mathlib.MeasureTheory.Measure.Lebesgue.Basic rh.RS.PoissonPlateau rh.RS.CRGreenOuter
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_rh_RS_DirectWedgeProof(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_rh_RS_PoissonPlateau(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
