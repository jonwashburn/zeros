...
// Module: rh.academic_framework.DiagonalFredholm.Operator
...
LEAN_EXPORT lean_object* initialize_rh_academic__framework_DiagonalFredholm_Operator(uint8_t builtin, lean_object* w) {
lean_object * res;
