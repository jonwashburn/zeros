...
// Module: rh.academic_framework.Certificate
// Imports: Init rh.Cert.KxiPPlus rh.Cert.K0PPlus
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_rh_academic__framework_Certificate(uint8_t builtin, lean_object* w) {
lean_object * res;
