...
// Module: rh.Proof.Export
// Imports: Init rh.Proof.Main rh.RS.PinchIngredients
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_rh_Proof_Export(uint8_t builtin, lean_object* w) {
lean_object * res;
